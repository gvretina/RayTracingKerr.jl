...
>>>>>>> 16e247eafdf7eb5237d2cb72d6de8308c793f476
...
function get_rotation_matrix(roll::Number, pitch::Number, yaw::Number)::AbstractArray
    ...
    SMatrix{D,D,Float64,16}(ApplyArray(vcat, [0, 0, 0, 0.0]', ApplyArray(hcat, [0.0, 0, 0], R_euler)))
end
...
function get_velocity_angles(v_fov::T, h_fov::T, dist::Float64,
    ...
    pixels_h == 1 ? th = [0.0] : th = atan.(dist, LinRange(-z_max, z_max, pixels_h)) .- pi / 2
    pixels_w == 1 ? ph = [0.0] : ph = atan.(dist, LinRange(-y_max, y_max, pixels_w)) .- pi / 2
>>>>>>> 16e247eafdf7eb5237d2cb72d6de8308c793f476
